...
export default class LessThan extends Operation {
    ...
    getValue(controller: Controller, symbolTable: SymbolTable): Expression {
        ...
        if (typeExp1 == enumType.INTEGER) {
            if (typeExp2 == enumType.INTEGER || enumType.DOUBLE) {
                ...
                return new Literal("Error semantico Menor que", enumType.ERROR);
            }
        ...
        return new Literal("Error semantico en menor que", enumType.ERROR);
    }
