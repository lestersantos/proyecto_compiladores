...
export default class GreaterEqual extends Operation {
    ...
    getValue(controller: Controller, symbolTable: SymbolTable): Expression {
        ...
        if (typeExp1 == enumType.INTEGER) {
            if (typeExp2 == enumType.INTEGER || enumType.DOUBLE) {
                ...
                return new Literal("Error semantico Mayor o igual", enumType.ERROR);
            }
        ...
        return new Literal("Error semantico en Mayor o igual", enumType.ERROR);
    }
}