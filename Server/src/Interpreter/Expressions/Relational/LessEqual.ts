...
export default class LessEqual extends Operation {
    ...
    getValue(controller: Controller, symbolTable: SymbolTable): Expression {
        ...
        if (typeExp1 == enumType.INTEGER) {
            if (typeExp2 == enumType.INTEGER || enumType.DOUBLE) {
                ...
                return new Literal("Error semantico Menor o igual que", enumType.ERROR);
            }
        ...
        return new Literal("Error semantico en Menor o igual que", enumType.ERROR);
    }
