...
export default class GreaterThan extends Operation {
    ...
    getValue(controller: Controller, symbolTable: SymbolTable): Expression {
        ...
        if (typeExp1 == enumType.INTEGER) {
            if (typeExp2 == enumType.INTEGER || enumType.DOUBLE) {
                ...
                return new Literal("Error semantico Mayor que", enumType.ERROR);
            }
        ...
        return new Literal("Error semantico en Mayor que", enumType.ERROR);
    }
